...
public class CommandsAdapterFactory extends AdapterFactoryImpl {
	...
	protected CommandsSwitch<Adapter> modelSwitch =
			...
			@Override
			public Adapter caseUpdateAgent(UpdateAgent object) {
				return createUpdateAgentAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.rcptt.cloud.agent.commands.UpdateAgent <em>Update Agent</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createUpdateAgentAdapter() {
		return null;
	}
