...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Get Task</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.rcptt.cloud.server.serverCommands.impl.GetTaskImpl#getSuiteId <em>Suite Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GetTaskImpl extends AgentCommandImpl implements GetTask {
	/**
	...
	protected EClass eStaticClass() {
		return ServerCommandsPackage.Literals.GET_TASK;
	}
	...
	public void setSuiteId(String newSuiteId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServerCommandsPackage.GET_TASK__SUITE_ID, oldSuiteId, suiteId));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ServerCommandsPackage.GET_TASK__SUITE_ID:
				return getSuiteId();
		}
