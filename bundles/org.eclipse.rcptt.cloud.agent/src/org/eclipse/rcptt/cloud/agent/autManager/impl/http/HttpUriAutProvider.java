...
public class HttpUriAutProvider extends BaseAutProvider {


	@Override
	public boolean isSupport(AutInfo aut) {
		return HttpSrc.isSupported(aut.getUri());
	}


	@Override
	protected ISrcFactory getMd5SourceFactory(AutInfo aut, String classifier) {
		return new HttpSrc(UriUtil.autMd5(aut.getUri(), classifier));
	}


	@Override
	protected ISrcFactory getZipSourceFactory(AutInfo aut, String classifier) {
		return new HttpSrc(UriUtil.autZip(aut.getUri(), classifier));
	}
